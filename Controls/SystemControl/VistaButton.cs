...
namespace DMS
{
    public class VistaButton : System.Windows.Forms.Control
    {
        ...
        private Color mHoverColor = Color.FromArgb(141, 189, 255);
        /// <summary>
        ...
        public Color HoverColor
        {
            ...
            set { mHoverColor = value; this.Invalidate(); }
        }
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            using (GraphicsPath rr = RoundRect(r, CornerRadius, CornerRadius, CornerRadius, CornerRadius))
            {
                ...
                SetClip(g);
                if (this.BackgroundImage != null) { g.DrawImage(this.BackgroundImage, this.ClientRectangle); }
                g.ResetClip();
        ...
        private void DrawGlow(Graphics g)
        {
            ...
            using (GraphicsPath glow = new GraphicsPath())
            {
                ...
                {
                    gl.CenterColor = Color.FromArgb(mGlowAlpha, this.HoverColor);
                    gl.SurroundColors = new Color[] { Color.FromArgb(0, this.HoverColor) };
                    g.FillPath(gl, glow);
                }
            }
            g.ResetClip();
        ...
        private void DrawText(Graphics g)
        {
            ...
            g.DrawString(base.Text, this.Font, new SolidBrush(this.ForeColor), r, sf);
        }
